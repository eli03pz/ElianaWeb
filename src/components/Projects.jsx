    ...
    <section className="py-24 px-6 relative" id="projects">
      <div className="max-w-6xl mx-auto space-y-24">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-2 text-dark-accent dark:text-neutral">
            {t("projects_title")}
          </h2>
        </div>
          ...
          <div className="bg-card-light dark:bg-card-dark border border-neutral/30 dark:border-white/10 rounded-[2rem] p-8 md:p-12 shadow-sm hover:shadow-xl transition-shadow duration-300">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h3 className="font-display text-4xl font-bold text-dark-accent dark:text-white">
                  Magnus Audit
                </h3>
                ...
                <div className="pt-4">
                  <a
                    className="inline-flex items-center text-dark-accent dark:text-white font-medium hover:text-primary dark:hover:text-primary transition-colors"
                    href="https://www.magnusauditec.com/"
                    target="_blank"
