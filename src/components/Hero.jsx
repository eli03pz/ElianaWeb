      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-center md:text-left">
          ...
          <div className="pt-6 flex justify-center md:justify-start gap-4">
            <a
              className="group relative px-6 py-3 bg-primary text-white rounded-full overflow-hidden shadow-lg shadow-primary/30 transition-all hover:shadow-primary/50 hover:-translate-y-1"
              href="#projects"
            >
            ...
            <a
              className="px-6 py-3 border border-dark-accent/20 dark:border-neutral/20 rounded-full hover:bg-dark-accent/5 dark:hover:bg-neutral/5 transition-colors"
              href="#contact"
            >
              {t("hero_contact")}
            </a>
        ...
        <div className="relative flex justify-center items-center h-full">
          <div className="relative w-72 h-80 md:w-80 md:h-96">
            ...
            <div
              className="absolute -left-6 bottom-12 w-16 h-16 bg-secondary rounded-lg rotate-12 float-animation shadow-lg z-20"
            ...
            <div className="absolute -bottom-10 -right-4 bg-white dark:bg-card-dark p-4 rounded-xl shadow-lg z-30 max-w-[150px] transform rotate-3">
              <p className="text-xs font-handwriting text-dark-accent dark:text-neutral">
                {t("hero_badge")}
              </p>
            </div>
          </div>
