...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-neutral/30 dark:bg-black/20 pt-20 pb-10 px-6 mt-12 border-t border-dark-accent/10 dark:border-white/5"
      id="contact"
    >
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-card-light dark:bg-card-dark rounded-3xl p-10 md:p-16 shadow-lg border border-neutral/20 dark:border-white/5 mb-16 relative overflow-hidden">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-6 text-dark-accent dark:text-white">
          ...
          <a
            className="inline-block px-8 py-4 bg-dark-accent text-white dark:bg-white dark:text-black rounded-full font-bold hover:scale-105 transition-transform shadow-lg"
            href="mailto:elianapinargote3@outlook.es"
          >
            {t("footer_send_email")}
          </a>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-dark-accent/10 dark:border-white/10 pt-10">
          <div className="mb-6 md:mb-0 text-left">
            <h4 className="font-display font-bold text-xl text-dark-accent dark:text-white">
              Eliana Pinargote
            </h4>
